...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="">
				<h1>Order #<?php echo $model->ID; ?> Review</h1>
	</div>
	
	<div class="">
		
		<div class="progress-bar">
			<div class="progress-bar-value" style="width:100%;"></div>
		</div>	
	...
	<div class="clearfix orderdetails narrow">
		...
		<?php echo $form->dropDownList($model,'branded_generic',array('1'=>'Article',
'2'=>'Press Release',
'3'=>'Web Page',
'4'=>' Blog',
'5'=>'Review',
...
'7'=>'Social Media',
'8'=>'Misc'),array('size'=>1,'maxlength'=>6,'readonly'=>true)); ?>
...
','215'=>'Weddings
','216'=>'White goods
','217'=>'Work'),array('size'=>1,'maxlength'=>6,'readonly'=>true)); ?>
		<?php echo $form->error($model,'subject'); ?>
	</div>

	<div class="clearfix orderdetails narrow">
		<?php echo $form->labelEx($model,'branded_generic'); ?>
		<?php echo $form->dropDownList($model,'branded_generic',array('1'=>'Branded ','2'=>'Generic'),array('size'=>1,'maxlength'=>6,'readonly'=>true)); ?>
		<?php echo $form->error($model,'branded_generic'); ?>
	</div>

	<div class="clearfix orderdetails narrow">
		<?php echo $form->labelEx($model,'keywords'); ?>
		<?php echo $form->textField($model,'keywords',array('size'=>50,'maxlength'=>250,'readonly'=>true)); ?>
	...
	<div class="clearfix orderdetails narrow">
		...
		<?php echo $form->textField($model,'additional_info',array('size'=>60,'maxlength'=>500,'readonly'=>true)); ?>
		<?php echo $form->error($model,'additional_info'); ?>
	</div>

	<div class="clearfix orderdetails narrow">
		<?php echo $form->labelEx($model,'Review'); ?>
		<?php echo $form->textField($model,'Review',array('id'=>'txtFirst','readonly'=>true)); ?>
