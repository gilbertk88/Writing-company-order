...
','217'=>'Work')); ?>
	...
	<div class="nav-buttons" style="text-align:center; width:70%;margin-top:30px;">
			 ...
			 $<?php echo $form->textField($model,'cost', array('readonly'=>true,'size'=>3,'style'=>'border:0px;font-size:20px;')); ?> <span id="times" style="display:none;">*</span> <span id="txtSecond" style="font-size:16px;"></span>   <?php echo CHtml::submitButton($model->isNewRecord ? 'Place Order' : 'Place Order',array('class'=>'btn success step_continue')); ?>
	</div>
<script>
