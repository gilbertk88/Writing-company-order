    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"> <img src="<?php echo Yii::app()->Request->baseUrl; ?>/bootadmin/images/writer.png" style="border: solid 1px grey; border-radius:5px; height:90px; width:;"></a>
            </div>
			...
			'items'=>array(
				...
				array('label'=>'Rress Release', 'url'=>array('/site/page', 'view'=>'press-release-writing-service')),
				array('label'=>'Blog', 'url'=>array('/site/page', 'view'=>'principal-writers')),
				array('label'=>'SEO', 'url'=>array('/site/page', 'view'=>'seo-web-content')),
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul class="list-inline">
                        ...
                        <li>
                            <a href="http://principalwriters.com/index.php/site/page?view=about">About</a>
                        </li>
                        <li class="footer-menu-divider">&sdot;</li>
                        <li>
                            <a href="http://principalwriters.com/index.php/site/page?view=press-release-writing-service">Services</a>
                        </li>
                        <li class="footer-menu-divider">&sdot;</li>
                        <li>
                            <a href="http://principalwriters.com/index.php/site/contact">Contact</a>
                        </li>
                    </ul>
                    <p class="copyright text-muted small">&copy;  <?php echo date('Y'); ?> by  principal writers.	All Rights Reserved</p>
                </div>
            </div>
        </div>
    </footer>
