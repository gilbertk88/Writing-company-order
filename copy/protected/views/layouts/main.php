    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
        <div class="container">
			...
			'items'=>array(
				...
				array('label'=>'Press Release', 'url'=>array('/press-release-writing-service')),
				array('label'=>'Blog', 'url'=>array('/principal-writers')),
				array('label'=>'SEO', 'url'=>array('/seo-web-content')),
...
<div class="" id="">
	...
	<div class="banner" style="margin-top:25px;">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <h2>easy to order, track and manage your content:</h2>
                </div>
                <div class="col-lg-6">
                    <ul class="list-inline banner-social-buttons">
                        <li>
                            <a href="<?php echo $this->createUrl('tblArticleOrder/create'); ?>" class="btn btn-default btn-lg"> <span class="network-name">PLACE AN ORDER IN SECONDS »</span></a>
                        </li>              
                    </ul>
                </div>
            </div>
