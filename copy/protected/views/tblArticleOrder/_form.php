	...
	'enableAjaxValidation'=>t,
		...
		<div class="clearfix">	
	  	...
	  	<div class="clearfix enterwords">	  		
			<div class="input">
				$<?php echo $form->textField($model, 'cost', array('size'=>20,'class'=>'cost','readonly'=>true,'style'=>'border:0px;font-size:20px;')); ?> 
				<?php echo $form->textField($model,'words',array('class'=>'wordcount', 'size'=>6,'maxlength'=>6, 'id'=>'0JobWords')); ?>	 	
